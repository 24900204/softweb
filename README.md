...
<html lang="en">
  <head>
    ...
    <style>
      body {
        ...
        margin: 0;
        background: linear-gradient(135deg, rgb(30, 5, 117), black);
        height: 100vh;
        display: flex;
      ...
      hr {
        border: none;
        height: 2px;
        background: linear-gradient(to right, rgb(22, 7, 186), black);
        margin: 15px;
      }
      ...
      .input-box input:focus {
        border-color: rgb(41, 52, 165);
        box-shadow: 0 0 8px rgba(40, 12, 139, 0.5);
      }
  ...
  <body>
    <div class="login-box">
      ...
      <div class="register">
        New to SIZZLE & SERVE? <a href="register.html">Create an account</a>
      </div>
    </div>
  </body>
</html>
...
<head>
  ...
  <style>
    ...
    .header {
      text-align: center;
      background: linear-gradient(to right, rgb(43, 26, 125), black);
      padding: 40px 0;
    ...
    nav ul li a:hover {
      color: rgb(63, 17, 172);
      text-shadow: 0 0 10px rgb(81, 35, 188);
    }
    .content {
      max-width: 1100px;
      margin: 60px auto;
    ...
    .offer {
      background: linear-gradient(90deg, rgb(46, 5, 104), rgb(27, 10, 91));
      padding: 20px;
      border-radius: 10px;
      margin: 30px auto;
      max-width: 700px;
    ...
    .gallery img {
      border-radius: 10px;
      box-shadow: 0 12px 25px rgba(219, 9, 9, 0.25);
...
<body>
  ...
  <footer>
    DESIGNED AND DEVELOPED BY RITHIKA L
  </footer>
...
<head>
  ...
  <style>
    ...
    header {
      text-align: center;
      background: linear-gradient(to right, rgb(39, 70, 223), black);
      color: rgb(29, 29, 164);
      padding: 25px 0;
      position: sticky;
      top: 0;
    ...
    a:hover {
      background-color: rgb(152, 146, 239);
      color: rgb(32, 60, 218);
    }
  </style>
</head>
...
<br>
<footer>
  © 2025 Sizzle & Serve Restaurant. All Rights Reserved.
</footer>
...
<head>
    <meta charset="UTF-8">
    <title>About Us - Sizzle & Serve</title>
    <style>
        body {
        ...
        header {
            background: linear-gradient(to right, rgb(70, 38, 186), black);
            color: goldenrod;
            top: 0%;
            position: fixed;
            width: 100%;
        ...
        a.back {
            ...
            text-decoration: none;
            color: black;
            background: rgb(141, 91, 235);
            padding: 10px 20px;
            border-radius: 8px;
            transition: 0.3s;
        }
        a.back:hover {
            background: rgb(16, 24, 58);
            color: white;
        }
        footer {
            text-align: center;
...
<div class="chef-section">
    ...
    <div class="chefs">
        <div class="chef-card">
            <a href="chef1.html"><img src="self.jpg"></a>
            <h3>Rithika L</h3>
            <p>CEO - BITEBOX</p>
        </div>  
...
<hr>
<footer>
    <p>© 2025 Sizzle & Serve. All Rights Reserved.</p>
</footer>
...
<html lang="en">
  <head>
    ...
    <style>
      body {
        background: linear-gradient(135deg, #1f378e, #261fa6);
        font-family: 'Poppins', Arial, sans-serif;
        display: flex;
        justify-content: center;
        align-items: center;
...
<img width="1918" height="1136" alt="image" src="https://github.com/user-attachments/assets/7f9e30e6-4adb-4922-beac-9b299b584703" />
