...
<body>
    ...
    <footer>
        <center> Designed and Developed by PRASANNA I (212223220079) </center>
    </footer>
</body>
</html>
```
    ...
    <div class="banner">
        ...
        <div class="navbar">
            ...
            <ul>
                ...
                <li><a href="products.html"> Products </a></li>
                <li><a href="person.html"> person </a></li>
                <li><a href="contactus.html" class="bg-contact"> Contact </a></li>
            </ul>
            <form action="" method="get">
                <input type="text" placeholder="Enter to Search">
                <button type="submit"> Search </button>
        ...
        <div class="box">
            ...
            <div class="box-2"> 
                ...
                <p> <span>Address</span> : No.81, pillayar Kovil Street, Naickanur Village,kavalur  Post,Thirupathur</p>
                <p> <span>Email</span> : rithikalokesh0702@gmail.com</p>
                <p> <span>Phone</span> : 9876543210 </p>
            </div>
        </div>
    </div>
    <footer>
        <center> Designed and Developed by RITHIKA L (212224230231)</center>
    </footer>
</body>
</html>
```
